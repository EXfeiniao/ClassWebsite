...
import com.blog.interceptor.service.TagService;
import com.blog.interceptor.service.TypeService;
...
public class IndexController {
    ...
    public String toIndex(@RequestParam(required = false,defaultValue = "1",value = "pagenum")int pagenum, Model model){
        ...
        List<Blog> recommendBlog =blogService.getAllRecommendBlog(true);  //获取推荐博客
